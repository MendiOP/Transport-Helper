...
public class ViewTruckingDetails extends JFrame {
    ...
    public ViewTruckingDetails(String username)  {
        ...
        ImageIcon i1  = new ImageIcon("icons/viewtrucking.jpg");
        ...
        lblName.setFont(new Font("Yu Mincho", Font.BOLD, 26));
        ...
        try{
            ...
            rs = c.statement.executeQuery("select * from intransport where name = '"+name+"'");
            while(rs.next()){
